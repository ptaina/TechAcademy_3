        ...
        while (true) {
            ...
            switch (progresso) {
                ...
                case 7:
                    ...
                    System.out.println("Escolhas:");
                    System.out.println("1. Confiar em Joe Goldberg: Gen resolve que a única maneira de obter respostas é confiar em Joe. Ela acredita que Scott está tentando desviar as suspeitas e decide se unir a Joe para confrontar Scott juntos. -Joe, como você é um amigo de longa data estou te confidencializando minhas conclusões para este caso, estou convencida de que Scott está escondendo algo. Precisamos confrontá-lo juntos e descobrir a verdade.");
