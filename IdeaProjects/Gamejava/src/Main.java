    ...
    private static void mostrarResultadoEscolha3(int escolha) {
        switch (escolha) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Cena 6.3: Ao refazer seus passos, Gen descobre que apenas duas pessoas na cidade possuem o modelo de carro próximo visto perto do local dos crimes. \n" +
